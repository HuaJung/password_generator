defmodule PasswordGeneratorWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {PasswordGeneratorWeb.Layouts, :root}
  ...
  scope "/", PasswordGeneratorWeb do
    ...
    get "/password-generator", PasswordGeneratorController, :index
    post "/password-generator", PasswordGeneratorController, :generate
  ...
  scope "/api", PasswordGeneratorWeb.Api do
    ...
    post "/password-generator", PasswordGeneratorController, :api_generate
